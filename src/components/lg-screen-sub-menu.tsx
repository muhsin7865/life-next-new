...
const LgScreenSubMenu = ({
  ...
  return (
    <div className=" flex justify-between my-auto items-center h-12 w-fit text-white ">
      ...
      >
        <Icon type="accountIcon" className="mb-1 " sizes={"lg"} />
      ...
      <button
        ...
        className="flex flex-col justify-between pl-5 items-center"
      >
        <Icon type="heartIcon" className="mb-1" sizes={"lg"} />
        <Typography size={"xs"} whitespace={"nowrap"}>{t.navbar.wishlist}</Typography>
      </button>
      ...
      <button className="relative flex flex-col justify-between pl-5 items-center group/cart">
        ...
        {domLoaded && cartItemsData && cartItemsData.length > 0 ? (
          <div className="group-hover/cart:scale-100 bg-white  scale-0 absolute w-[25rem] top-[3rem] right-0  rounded-lg p-3   h-fit  shadow-lg z-30">
