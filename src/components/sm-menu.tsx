...
const SmMenu = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 md:hidden bg-white  border-t border-muted  py-2 pb-3 items-center z-30 ">
      <div className="flex justify-between sm:px-6 px-5">
        {menuItems.map((item) => (
    
            <button onClick={() => item.onClick()} className="relative flex flex-col">
              <Image
