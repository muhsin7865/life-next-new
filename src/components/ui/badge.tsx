...
const ProductRatingBadge = ({
  ...
  return (
    <>
      ...
      >
        <Icon sizes={"sm"} type="starIcon" className="fill-white my-auto" />

        <Typography size={"sm"}>{productRating}</Typography>
      </span>

      <span
        className="absolute right-2 bottom-2 bg-white/70 backdrop-blur-sm p-1 rounded-full cursor-pointer "
